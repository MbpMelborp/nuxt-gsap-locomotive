  ...
  methods: {
    initTimelines() {
      ...
      this.tl_preload_salida.fromTo(
        '.capa_2',
        abierto,
        { ...cerradoToLeft, delay: 0, duration: tiempoEntrada },
        'salida+=0'
      )
      this.tl_preload_salida.fromTo(
        '.preloadp .marquee',
...
.preloadp {
  ...
  .preload {
    ...
    .marquee {
      ...
      display: grid;
      grid-template-columns: [l1] auto [r1];
      grid-template-rows: [t1] auto 42vh auto [b1];
      grid-gap: 0;
      width: 100vw;
      height: 100vh;
      align-items: center;
